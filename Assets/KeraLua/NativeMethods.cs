...
namespace KeraLua
{
    static class NativeMethods
    {
        ...
        //internal static extern int luaL_loadstring_byte(IntPtr luaState, byte[] chunk);
        ...
        internal static extern int luanet_isstring_strict(IntPtr luaState, int index);
        ...
        internal static extern int luaL_checkmetatable(IntPtr luaState, int obj);
        ...
        internal static extern int luanet_sethook(IntPtr luaState, IntPtr func, int mask, int count);
        ...
        internal static extern IntPtr luanet_get_main_state(IntPtr luaState);
    }
}